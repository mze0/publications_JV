...
load("/uz/data/avalok/symbiosys/gcpi_r_kul_thierry_voet/mzaman0_gsclu01/mzaman0/refData/Ideogram_hg19.rda")
#load("/data/home/mzaman0/refData/CytoSNP12_RefLogRsNorm.rda")
