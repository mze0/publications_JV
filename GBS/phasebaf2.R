phasebaf2 <- function(Gtypes,dataraw,Family,Parent1,gamma,outPath){ 

print("Computing phased BAF...")


source("callpcfBAF.R")
source("phgrandparents.R")
...
PhBAF[["P1Seg"]] <- callpcfBAF(PhBAF[["P1"]],gammaSC,gammaMC,plateau)
PhBAF[["P2Seg"]] <- callpcfBAF(PhBAF[["P2"]],gammaSC,gammaMC,plateau)
PhBAF[["M1Seg"]] <- callpcfBAF(PhBAF[["M1"]],gammaSC,gammaMC,plateau)
PhBAF[["M2Seg"]]<- callpcfBAF(PhBAF[["M2"]],gammaSC,gammaMC,plateau)
