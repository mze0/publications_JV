htypingAutOpt2 <- function(Gtypes,Father,Mother,Ref,Sibs){

print("*******************************************")
print("****     Option2 Htype analysis...     ****")

source("phparents1.R") #phparents function
print("-------------------------------------------")
...
#Determination of paternal and maternal haplotypes
	...
	print(paste("Sibling",gsub("E0_Bl0_","",colnames(Sibs)[sib]),"is phased"))
...
colnames(PatHaps)<-paste(gsub("E0_Bl0_","",colnames(Sibs)),"_Pat",sep="")
colnames(MatHaps)<-paste(gsub("E0_Bl0_","",colnames(Sibs)),"_Mat",sep="")
